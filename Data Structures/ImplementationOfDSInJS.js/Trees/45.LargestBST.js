// We need to return the size of the largest BST in the tree that follows the BST rule => size = no.of nodes
// We can check on every node isValidBST then find the number of elements in it => O(N) * O(N)=> O(N^2)
